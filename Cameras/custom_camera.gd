...
var rng :RandomNumberGenerator = RandomNumberGenerator.new() # For positioning flyby camera
const target_close_up_dist :float =-30.0 # For positioning target close-up camera
