...
@export var max_angle :float = 70.0 ## Degrees
var min_angle :float = 0.0 ## Degrees

## Distance at which the factor for world environment modification is one.
@export var unit_distance :float = 700.0

# Currently brightness goes up to 4x
@export var max_brightness_factor :float = 4.0 ## Max factor by which brightness will be scaled when the camera is staring into the explosion.
var min_brightness_factor :float = 1.0
...
@export var max_contrast_factor :float = 3.0 ## Max factor by which contrast will be scaled when the camera is staring into the explosion.
var min_contrast_factor :float = 1.0
# Currently saturation is only lowered, which leaches color
# out of the world.
var max_saturation_factor :float = 1.0
@export var min_saturation_factor :float = 0.0 ## Min factor by which saturation will be scaled when the camera is staring into the explosion.

@export var brightness_change_duration :float = 0.3 ## Seconds
@export var contrast_change_duration :float = 0.4 ## Seconds
@export var saturation_change_duration :float = 1.5 ## Seconds
