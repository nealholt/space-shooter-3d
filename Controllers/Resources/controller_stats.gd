...
@export_range(0, 500, 1.0, "or_greater") var impulse :float= 60.0
@export_range(0, 4, 0.1, "or_greater") var pitch :float= 1.8
@export_range(0, 4, 0.1, "or_greater") var roll :float= 0.6
@export_range(0, 4, 0.1, "or_greater") var yaw :float= 0.6
...
@export_range(0.1, 100, 0.1, "or_less") var impulse_lerp :float= 1.0 # Used to be 1 for player and 10 for NPCs
# turning_lerp is the lerp used for changing pitch,
# roll, and yaw.
@export_range(0.1, 100, 0.1, "or_less") var turning_lerp :float= 3.5
