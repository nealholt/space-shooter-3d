...
func Physics_Update(_delta:float) -> void:
	...
	motion.goal_strafe_y = 0.0
	motion.goal_strafe_x = 0.0
	print(motion.orientation_data.dist_sqd)
	...
	## Seek target if too far away
		...
		#motion.goal_strafe_x = 0.0 # Reset
			...
			#pitch_target_ahead()
			#yaw_target_ahead()
			#motion.goal_speed = 0.0 # TESTING
			#motion.goal_strafe_y = 0.0 # Reset # TESTING
			#motion.goal_strafe_x = 0.0 # Reset # TESTING
			##print(motion.goal_yaw)
